...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedRestaurants() {
        List<Restaurant> restaurants = Arrays.asList(
                ...
                createRestaurant("South Indian", "Crispy Dosas and South Indian Delicacies", 4.6, "25-35 min", "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Rameshwaram_Cafe_Dosa.jpg/500px-Rameshwaram_Cafe_Dosa.jpg"),
